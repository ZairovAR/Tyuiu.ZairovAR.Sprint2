...
namespace Tyuiu.ZairovAR.Sprint2.Task2.V21
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* и вычисляет находится ли точка с координатами X,Y в заштрихованной обла-*");
            Console.WriteLine("* сти.                                                                    *");
            Console.WriteLine("***************************************************************************");
